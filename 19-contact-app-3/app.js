...
// ! halaman proses delete
app.get('/contact/delete/:nama', (req,res) => {
    // ? cari kontak dulu
    const contact = findContact(req.params.nama)

    // ? jika yang dimasukan bukan dari kontak
    if (!contact) {
        res.status(404)
        res.send(`<h2>404</h2>`)
    } else {
        ...
        // ? menampilkan pesan sukses
        req.flash('msg','Data Contact Sudah Berhasil dihapus !')
        // ? fungsi bawaan
        res.redirect('/contact')
    }
})
...
app.post('/contact/update',[
    ...
    if (!errors.isEmpty()){
        ...
        // ? menampilkan pesan sukses
        req.flash('msg','Data Contact Sudah Berhasil diubah !')
        // ? fungsi bawaan
        res.redirect('/contact')
    }
})
